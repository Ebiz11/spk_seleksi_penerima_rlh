...
if (isset($_POST['cari'])) {
  ...
  $lap_penerima=$individu->cari_penerima($start, $end, "N");
 ...
 <div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-9">
       <h2>Laporan Pengajuan Ditolak</h2>
       <ol class="breadcrumb">
           <li>
               <a href="index?page=home">Home</a>
           </li>
           <li class="active">
               <strong>Laporan Pengajuan Ditolak</strong>
           </li>
       </ol>
   </div>
 </div>
      ...
      <div class="row">
          ...
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <!-- <h5>Laporan Pengajuan Ditolak</h5> -->
              ...
              <tbody>
                ...
                ?>
                  <tr class="gradeX">
                      <td><?php echo $no++ ?></td>
                      <?php extract($individu->det_penduduk($datalap_penerima['no_ktp'])); ?>
                      <td><a href="index?page=detail_calon_penerima&id_calon_penerima=<?php echo $datalap_penerima['id_calon_penerima'] ?>"><?php echo $nama ?></a></td>
